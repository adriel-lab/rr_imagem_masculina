				...
				<div class="offcanvas-lg offcanvas-start h-100" tabindex="-1" id="offcanvasSidebar">
					...
					<div class="card-body p-0 mt-4">
										...
										<ul class="nav nav-pills-primary-border-start flex-column">
											...
											<li class="nav-item">
												<a class="nav-link" href="account-notification.php"><i class="bi bi-bell fa-fw me-2"></i>Permições</a>
											</li>
											<li class="nav-item">
											...
											<li class="nav-item">
												<a class="nav-link active" href="account-delete.php"><i class="bi bi-trash fa-fw me-2"></i>Deletar Perfil</a>
											</li>
											<li class="nav-item">
