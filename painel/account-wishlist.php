						...
						<div class="card border p-3 w-100">
							...
							<div class="card-body p-0 mt-4">
								...
								<ul class="nav nav-pills-primary-border-start flex-column">
									...
									<li class="nav-item">
										<a class="nav-link" href="account-notification.php"><i class="bi bi-bell fa-fw me-2"></i>Notification</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="account-projects.php"><i class="bi bi-briefcase fa-fw me-2"></i>My projects</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="account-payment-details.php"><i class="bi bi-wallet fa-fw me-2"></i>Payment details</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="account-order.php"><i class="bi bi-basket fa-fw me-2"></i>Order history</a>
									</li>
									<li class="nav-item">
										<a class="nav-link active" href="account-wishlist.php"><i class="bi bi-heart fa-fw me-2"></i>Wishlist</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="account-delete.php"><i class="bi bi-trash fa-fw me-2"></i>Delete profile</a>
									</li>
									<li class="nav-item">
			...
			<div class="col-lg-8 col-xl-9 ps-lg-4 ps-xl-6">
				...
				<div class="card bg-transparent">
							...
							<div class="col-7 col-md-10">
								<div class="row g-4">
									...
									<div class="col-xl-6">
										...
										<h6 class="mb-1"><a href="#">Round neck cotton t-shirt</a></h6>
										<small class="text-primary">In Stock</small>
										<!-- List -->
									...
									<div class="col-md-6 col-xl-3 text-md-end">
										<h5 class="mb-2">$103.00</h5>
										<button class="btn btn-sm btn-dark mb-0"><i class="bi bi-cart3 me-2"></i>Add to cart</button>
									</div>
								</div>
							</div>
						</div>	
						...
						<div class="row align-items-xl-center">
							...
							<div class="col-7 col-md-10">
								<div class="row g-4">
									...
									<div class="col-xl-6">
										<!-- Product detail START -->
										<h6 class="mb-1"><a href="#">Woman skincare drops</a></h6>
										<small class="text-primary">Available in 5 days</small>
										<!-- List -->
										<ul class="nav nav-divider small align-items-center mt-1">
											<li class="nav-item">Gender: Female</li>
											<li class="nav-item">Size: 100ml</li>
										</ul>
									</div>
									...
									<div class="col-md-6 col-xl-3">
										...
										<!-- Buttons -->
										<div class="hstack gap-2 flex-wrap text-primary-hover mt-2 justify-content-md-end">
											<a href="#" class="text-reset small"><i class="bi bi-trash3 me-1"></i>Remove</a>
											<a href="#" class="text-reset small"><i class="bi bi-heart me-1"></i>Save for later</a>
										</div>
									</div>
	
									<!-- Price and button -->
									<div class="col-md-6 col-xl-3 text-md-end">
										<h5 class="mb-2">$98.00</h5>
										<button class="btn btn-sm btn-dark mb-0"><i class="bi bi-cart3 me-2"></i>Add to cart</button>
									</div>
								</div>
							</div>
					...
					<div class="card-footer bg-transparent text-end p-0">
						<button class="btn btn-light border mb-0">Continue shopping</button>
					</div>
				</div>
			</div>
		</div>
